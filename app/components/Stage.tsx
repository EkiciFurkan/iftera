...
export default function Stage({ onIfGoClick }: StageProps) {
    return (
        <div className="flex flex-col h-screen bg-[#F9F9F9] overflow-hidden">
            ...
            <header className="bg-[#D32F2F] pt-12 pb-4 px-4 shadow-sm relative z-20">
                <div className="flex items-center justify-between">
                    <div className="flex flex-col">
                        ...
                        <span className="text-white/80 text-[10px] tracking-widest uppercase ml-8">Street Food Hall</span>
                    </div>
            ...
            {/* BOTTOM NAVIGATION */}
            <div className="bg-white border-t border-neutral-200 px-6 py-3 flex items-center justify-between relative z-30 pb-8">
